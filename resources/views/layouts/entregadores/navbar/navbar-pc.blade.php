...
<nav class="navbar navbar-expand-md navbar-dark bg-secundario d-none d-md-block" id="navbar-main">
    <div class="container-fluid justify-content-between">
        ...
        {{-- <div class="row">
            <div class="col-auto">
                <!-- Search form -->
                <form action="{{route('entregador.pesquisar-pacote')}}" class="navbar-search form-inline mr-sm-3" id="navbar-search-main">
                    <div class="form-group mb-0">
                        <div class="input-group input-group-alternative input-group-merge bg-white">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-search"></i></span>
                            </div>
                            <input class="form-control" placeholder="Pesquisar pacote" type="text"
                                style="width: 10rem">
                        </div>
                    </div>
                </form>
            ...
            <form class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
                <div class="form-group mb-0">
                    <div class="input-group input-group-alternative input-group-merge">
                        ...
                        <input class="form-control" placeholder="Searchs" type="text">
                    </div>
                </div>
