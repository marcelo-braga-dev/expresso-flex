        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white mb-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title text-uppercase mb-0">Histórico de Pagamentos</h4>
                    </div>
                    <div class="col-auto">
                    ...
                    @foreach ($fretes as $frete)
                        <li
                            ...
                            <a class="btn btn-link p-0 btn-sm"
                                href="{{ route('cliente.financeiro.pagamentos.detalhes-mensal', ['mes' => $frete['mes'], 'ano' => $frete['ano']]) }}">
                                Detalhes
                            </a>
                        </li>
                    @endforeach
