@extends('layouts.admin', ['title' => 'Faturamento na Quinzena do Entregador', 'menu_suspenso' => 'financeiro'])
        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white mb-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title text-uppercase mb-1">Faturamento na Quinzena do Entregador</h4>
                    ...
                    @foreach ($fretes['periodos'] as $frete)
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 info-list">
                            ...
                            <a class="btn btn-link p-0 btn-sm"
                                href="{{ route('admin.financeiro.entregador.detalhes-mensal', [
                                    'mes' => $fretes['mes'],
                                    'ano' => $fretes['ano'],
                                    'quinzena' => $i++,
                                    'id' => $user,
