<x-layout menu="pacotes" submenu="pacotes-pesquisar">
                ...
                <div class="row">
                    <div class="col-md-8 mb-5">
                        <div class="card mb-3 p-4 pb-1">
                            <form action="{{-- route('admins.pacotes.pesquisar.show') --}}"> @csrf
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <div class="form-group m-0">
                                            <input type="text" name="codigo"
                                                   class="form-control form-control-alternative" value="{{ $_GET['codigo'] ?? '' }}"
