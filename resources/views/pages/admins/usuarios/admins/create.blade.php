        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white mb-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title text-uppercase mb-0">Cadastro de Administrador</h4>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('admins.usuarios.admins.store') }}" autocomplete="off">
                    @csrf

                    <div class="px-lg-4">
                        <h6 class="heading-small text-muted mb-4">Informações do Administrador</h6>
                    </div>
