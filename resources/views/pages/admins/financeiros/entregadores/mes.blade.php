<x-layout menu="financeiro" submenu="financeiro-entregadores">
        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white mb-0">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title text-uppercase mb-1">Histórico de Faturamento</h4>
                    ...
                    @foreach ($fretes as $frete)
                        <li
                            ...
                            <a class="btn btn-link p-0 btn-sm"
                               href="{{ route('admins.financeiros.entregadores.quinzena', ['id' => $id, 'mes' => $frete['mes'], 'ano' => $frete['ano'] ]) }}">
                                Detalhes
                            </a>
                        </li>
                    @endforeach
