                    ...
                    <div class="px-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control form-control-alternative"
                                   value="@if (isset($user['name'])){{ $user['name'] }}@endif" required autofocus>
                        </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="celular" id="celular"
                                           class="form-control form-control-alternative"
                                           value="@if (isset($user['celular'])){{ $user['celular'] }}@endif"
                                           required autofocus>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="razao_social" id="razao_social"
                                           class="form-control form-control-alternative"
                                           value="@if (isset($user['razao_social'])){{ $user['razao_social'] }}@endif"
                                           autofocus>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nome_fantasia" id="nome_fantasia"
                                   class="form-control form-control-alternative"
                                   value="@if (isset($user['nome_fantasia'])){{ $user['nome_fantasia'] }}@endif"
                                   autofocus>
                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nome_comercial" id="nome_comercial"
                                           class="form-control form-control-alternative"
                                           value="@if (isset($user['nome_comercial'])){{ $user['nome_comercial'] }}@endif"
                                           autofocus>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email_comercial" id="email_comercial"
                                           class="form-control form-control-alternative"
                                           value="@if (isset($user['email_comercial'])){{ $user['email_comercial'] }}@endif"
                                           autofocus>
                                </div>
                            </div>
                        </div>
